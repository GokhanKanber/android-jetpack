...
import com.gokhankanber.android.architecture.paging.model.source.local.converter.DateConverter;
...
{
    private static final String DATABASE_NAME = "note-content";
    ...
    private static final Migration MIGRATION1_2 = new Migration(1, 2)
    {
        ...
        {
            supportSQLiteDatabase.execSQL("CREATE TABLE x_" + Note.TABLE_NAME);
        }
    };
}
